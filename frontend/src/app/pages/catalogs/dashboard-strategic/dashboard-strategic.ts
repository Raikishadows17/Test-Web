...
export class DashboardStrategic implements OnInit {
  ...
  private allData: any[] = [
    ...
    },
    {
      ...
      estimatedKm: 110,
      estimatedTime: '1:40',
      estimatedDelivery: '2026-02-27T16:30'   // próxima entrega
    }
  ];
  ngOnInit() {
  ...
  editSolicitudService(unit: any) {
    this.router.navigate(['/dashboard/service-request/edit', unit.folio], {
      state: { selectedService: unit }
    });
  }
}
